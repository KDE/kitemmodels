...
public:
     ...
     * \param row the row number for which the proxy model is querying for data (child of \param parent, if set)
     ...
     *
     * Returns the data at \param row and \param extraColumn
     */
