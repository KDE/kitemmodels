...
public:
    ...
    /*!
     * Maps the \param index from the left model to the right model.
     */
    QModelIndex mapLeftToRight(const QModelIndex &index) const;

    /*!
     * Maps the \param index from the right model to the left model.
     */
    QModelIndex mapRightToLeft(const QModelIndex &index) const;

    /*!
     * Maps the \param selection from the left model to the right model.
     */
    QItemSelection mapSelectionLeftToRight(const QItemSelection &selection) const;

    /*!
     * Maps the \param selection from the right model to the left model.
     */
